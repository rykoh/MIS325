...
DROP TABLE ubc_member_committees ;
DROP TABLE ubc_members ;
DROP TABLE ubc_committees ;
...
--	CONSTRAINT valid_semester_check  CHECK (semester_year in ('SP19','FA19','SP20','FA20','SP21','FA21'))
--);
-- 
-- 
...
--SEED COMMITTEE DATA FOR FALL 2019 and SPRING 2020
...
--INSERT INTO ubc_COMMITTEES
--VALUES (5,'VIP Committee ', 'FA19');
 
--INSERT INTO ubc_COMMITTEES
--VALUES (6,'DINE with Professors', 'FA19');
 
--INSERT INTO ubc_COMMITTEES
--VALUES (7,'Internal Controls', 'FA19');
 
--INSERT INTO ubc_COMMITTEES
--VALUES (8,'Company Field Trip', 'FA19');
...
------------------------------------------------------------------------------------------------
--------------  START of the Accounts Payable and other textbook tables
------------------------------------------------------------------------------------------------  
...
(
  ...
  CONSTRAINT orders_fk_CUSTOMERS_OM
	FOREIGN KEY (customer_id) REFERENCES CUSTOMERS_OM (customer_id)
);
...
BEGIN
  ...
  EXECUTE IMMEDIATE 'DROP TABLE orders_mgs';
...
--updates the invoice_dates to by current 2019 dates and not 2014 so we can test out sysdate in where clause
update invoices
set invoice_date = invoice_date + (365*5+60),
    invoice_due_date = invoice_due_date + (365*5+60),
    payment_date = payment_date + (365*5+60);
...
Select vendor_ID, vendor_name, vendor_address1, vendor_address2, vendor_city, vendor_state, vendor_zip_code 
from vendors
order by vendor_state asc, vendor_city asc, vendor_name asc;

Select vendor_ID, vendor_name, vendor_address1, vendor_address2, vendor_city, vendor_state, vendor_zip_code 
from vendors
order by 6 asc, 5 asc, 2 asc;

select vendor_id as 'Vendor Number'
from vendors;
